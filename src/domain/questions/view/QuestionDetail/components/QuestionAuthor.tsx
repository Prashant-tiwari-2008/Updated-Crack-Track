      ...
      <div className="card-body p-0">
        ...
        <div className="text-center">
          ...
          <div className="mt-4">
            ...
            <a href="blog-about.html" className="text-primary h5 mt-4 mb-0 d-block">{author.pluck('username')}</a>
        ...
        <div className="widget mt-4">
          ...
          <div className="mt-4">
            <div className="d-flex align-items-center">
              <img src="assets/images/blog/01.jpg" className="avatar avatar-small rounded" style={{width: 'auto'}} />
              <div className="flex-1 ms-3">
                <a href="javascript:void(0)" className="d-block title text-dark">Consultant Business</a>
                <span className="text-muted">15th April 2021</span>
              </div>
            </div>
            <div className="d-flex align-items-center mt-3">
              <img src="assets/images/blog/02.jpg" className="avatar avatar-small rounded" style={{width: 'auto'}} />
              <div className="flex-1 ms-3">
                <a href="javascript:void(0)" className="d-block title text-dark">Grow Your Business</a>
                <span className="text-muted">15th April 2021</span>
              </div>
            </div>
            <div className="d-flex align-items-center mt-3">
              <img src="assets/images/blog/03.jpg" className="avatar avatar-small rounded" style={{width: 'auto'}} />
              <div className="flex-1 ms-3">
                <a href="javascript:void(0)" className="d-block title text-dark">Look On The Glorious Balance</a>
                <span className="text-muted">15th April 2021</span>
              </div>
            </div>
          </div>
